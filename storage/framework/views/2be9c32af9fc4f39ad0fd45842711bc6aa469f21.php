...
<div class="col-12">
  <div class="card-box">
    ...
    <?php echo e(Form::open(['route' => 'produto.store', 'files' => true])); ?>
            ...
            <div class="row">
              ...
              <div class="form-group col-md-4" >
                ...
                <input type="file" name="logo" class="filestyle" data-placeholder="Enviar Logo" data-btnClass="btn-light" required="required">
              </div>
            ...
            <div class="row">
              <div class="form-group col-md-12">
                  ...
                  <?php echo e(Form::text('descricao', null, array('class' => 'form-control'))); ?>
            ...
            <div class="row">
              <div class="form-group col-md-6">
                  ...
                  <?php echo e(Form::textarea('indicacoes', null, array('class' => 'form-control'))); ?>

              </div>
              <div class="form-group col-md-6">
                  <?php echo e(Form::label('mododeusar', 'Modo de Usar')); ?>

                  <?php echo e(Form::textarea('mododeusar', null, array('class' => 'form-control'))); ?>
