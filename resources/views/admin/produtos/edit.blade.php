    ...
    {!! Form::model($produto, array('route' => ['produto.update', $produto->id], 'method' => 'PUT', 'files' => true)) !!}
        <div class="row">
          ...
          <div class="form-group col-md-4">
            ...
            <input type="file" name="imagem" class="filestyle" data-placeholder="{!!$produto->imagem!!}" data-btnClass="btn-light">
          </div>
        </div>
        <div class="form-group col-md-4">
          {!! Form::label('logo', 'Enviar Logo') !!}
          <input type="file" name="logo" class="filestyle" data-placeholder="{!!$produto->logo!!}" data-btnClass="btn-light">
        </div>
      </div>
        <div class="row">
