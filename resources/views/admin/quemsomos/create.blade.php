    ...
    {{ Form::open(['route' => 'quemsomos.store']) }}
      ...
      <div class="row">
        <div class="form-group col-md-8">
          ...
          <input type="file" name="imagem2" id="imagem2" class="filestyle" data-buttonText="Carregar" data-placeholder="Resolução ideal 640 × 432  " data-btnClass="btn-light" required>
        </div>
        <div class="form-group col-md-4">
          <img src="{{URL::asset('/assets/images/img-1.jpg')}}" id="profile-img-tag" class="form-control preview" style="height:100px"/>
          <!-- Altura definida pelo CSS -->
